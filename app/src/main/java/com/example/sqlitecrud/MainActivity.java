...
private List<Employee> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   SQLiteDatabase database = dbHelper.getReadableDatabase();
      //  database.close();
    findViewById(R.id.btnEdit_338).setOnClickListener(this);
    findViewById(R.id.btnInsert_338).setOnClickListener(this);
    findViewById(R.id.btnDelete_338).setOnClickListener(this);

    lvEmployees = findViewById(R.id.lvEmployees_338);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btnInsert_338:
                startActivity(intent);
                break;
            case R.id.btnEdit_338:
                if(employeeId == null){
